    ...
    _createClass(Attend, [{
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 3:
                                data = _context2.sent;
                                return _context2.abrupt('return', data.Items[0]);
        ...
        value: function () {
            var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(token) {
                var current, params, data;
                return regeneratorRuntime.wrap(function _callee3$(_context3) {
                    while (1) {
                        switch (_context3.prev = _context3.next) {
                            case 0:
                                current = _moment2.default.utc().unix();
                                params = {
                                    "TableName": _tables2.default.attendCode,
                            ...
                            case 4:
                                ...
                                return _context3.abrupt('return', data.Items[0].attendId);
        ...
        key: 'parseAttend',
        value: function parseAttend(attend) {
            return {
        ...
        key: 'dataFromToken',
        value: function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(attendCode) {
                var attendId, attend, u, _ref5, _ref6, userGuild, event, a;
                ...
                return regeneratorRuntime.wrap(function _callee4$(_context4) {
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            case 0:
                                _context4.next = 2;
                                return this.checkToken(attendCode);

                            case 2:
                                attendId = _context4.sent;
                                _context4.next = 5;
                                return this.getAttend(attendId);

                            case 5:
                                attend = _context4.sent;
                                u = new _User2.default();
                                _context4.next = 9;
                                return Promise.all([u.getUserSettings(attend.userId), this.getEvent(attend.eventId)]);
        ...
        key: 'updateAttend',
        value: function () {
            var _ref7 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(id, status, lateTime) {
                var params, data;
                return regeneratorRuntime.wrap(function _callee5$(_context5) {
                    while (1) {
                        switch (_context5.prev = _context5.next) {
                            case 0:
                                params = {
                                    ...
                                    ExpressionAttributeValues: {
                                        ':status': status,
                                        ":lateTime": lateTime,
                                        ":statusChanged": _moment2.default.utc().unix()
                                    },
                            ...
                            case 3:
                                data = _context5.sent;
                                return _context5.abrupt('return', data.Attributes);
            ...
            function updateAttend(_x5, _x6, _x7) {
        ...
        key: 'saveAttend',
        value: function () {
            var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(attendCode, data) {
                var response, attendId, late, updated;
                return regeneratorRuntime.wrap(function _callee6$(_context6) {
                    while (1) {
                        switch (_context6.prev = _context6.next) {
                            case 0:
                                response = this.validResponse.find(function (r) {
                            ...
                            case 5:
                                ...
                                _context6.next = 10;
                                return this.updateAttend(attendId, response, late);

                            case 10:
                                updated = _context6.sent;
                                return _context6.abrupt('return', this.parseAttend(updated));
...
var _Attend = __webpack_require__(339);
...
module.exports.f = function (event, context, callback) {
    ...
    var a = new _Attend2.default();
    a.saveAttend(event.pathParameters.token, JSON.parse(event.body)).then(success).catch(error);
};
